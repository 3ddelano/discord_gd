...
var guild_member = null # [GuildMember] The guild member that this thread member belongs to. This will never be present when fetching over REST
...
func update(p_dict):
	if p_dict.get("flags") != null:
		flags = p_dict.get("flags")
